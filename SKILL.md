...
# code-shiniyaya v4.7.1 — codex-plugin-cc 集成

v4.7.1 — codex-plugin-cc integrated. STEP 4/6 auto via /codex:review + /codex:rescue. Anti-pattern 24 added for manual paste loop. Codex通信模型 upgraded from manual-only to plugin-primary + manual-fallback.
