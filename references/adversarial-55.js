...
// → code-shiniyaya echo-guard v3.4 dual-timestamp (L146-149)
check('F7: autodream multi-threshold semantics → echo-guard v3.4 dual-timestamp (extracted pattern)', true);
